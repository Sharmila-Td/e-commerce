    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
        ...
        <div className='min-w-60'>
            <p className='my-2 text-xl flex items-center cursor-pointer gap-2' onClick={()=>setShowFilter(!showFilter)}>FILTERS
              <MdDoubleArrow className={`h-5 sm:hidden ${showFilter ? 'rotate-90' : ''}`}/>
            </p>
            {/* Category filter*/}
        ...
        <div className='flex-1'>
            <div className='flex justify-between text-base sm:text-2xl mb-4'>
               ...
               <select className='border-2 border-gray-300 text-sm px-2'>
                    <option value="relavent" onChange={(e)=>setSortType(e.target.value)}>Sort by: Relavant</option>
                    <option value='low-high' onChange={(e)=>setSortType(e.target.value)}>Sort by: Low to High</option>
                    <option value='high-low' onChange={(e)=>setSortType(e.target.value)}>Sort by: High to Low</option>
               </select>
            </div>
            {/* Map products */}
